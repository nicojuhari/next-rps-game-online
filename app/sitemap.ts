...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    return [
        ...
        { url: `${BASE}/es/about`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.3 },
        { url: `${BASE}/pt/about`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.3 },
        { url: `${BASE}/de/about`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.3 },
        { url: `${BASE}/fr/about`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.3 },
        { url: `${BASE}/blog`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.6 },
        { url: `${BASE}/es/blog`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.5 },
        { url: `${BASE}/pt/blog`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.5 },
        { url: `${BASE}/de/blog`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.5 },
        { url: `${BASE}/fr/blog`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.5 },
        ...
        { url: `${BASE}/es/terms`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.2 },
        { url: `${BASE}/pt/terms`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.2 },
        { url: `${BASE}/de/terms`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.2 },
        { url: `${BASE}/fr/terms`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.2 },
        ...blogEntries,
    ];
}
