...
export const metadata = createMetadata({
    ...
    description:
        "Play Rock Paper Scissors with friends online! Create or join a game room and challenge your friends in real-time multiplayer RPS battles.",
...
const TwoPlayers = () => {
    return (
        <Suspense
            fallback={
                <div className="py-8">
                    <h1 className="text-xl mb-4 text-center">RPS - 2 Players Game</h1>
