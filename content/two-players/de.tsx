...
export const faqItems: FaqItem[] = [
    ...
    {
        q: "Können wir von verschiedenen Geräten spielen?",
        a: "Ja. Ein Spieler am PC, der andere am Handy - funktioniert auf jedem Gerät mit Browser.",
    },
    {
        q: "Kann man den Zug des anderen sehen, bevor man wählt?",
        a: "Nein. Beide Züge bleiben verborgen, bis beide Spieler fertig sind. Kein Spicken, kein Schummeln.",
    },
    {
        q: "Was passiert, wenn ich den Browser schließe?",
        a: "Der Spielraum bleibt offen. Öffne den Link erneut und mach weiter, wo du aufgehört hast.",
    },
    { q: "Kann ich auf dem Handy spielen?", a: "Ja. Das Spiel funktioniert auf jedem Smartphone oder Tablet." },
    {
        q: "Können wir Stein Papier Schere nutzen, um eine Wette zu lösen oder eine Entscheidung zu treffen?",
        a: "Ja. Online spielen ist fairer als in Person - beide Entscheidungen werden gesperrt, bevor einer der Spieler das Ergebnis sieht, sodass niemand seinen Zug im letzten Moment ändern kann. Es ist das gleiche Prinzip wie ein Münzwurf, außer dass beide Spieler aktiv teilnehmen.",
    },
    {
        q: "Können wir Stein Papier Schere bei einem Zoom- oder Videoanruf spielen?",
        a: "Ja. Öffne das Spiel auf deinem eigenen Gerät während des Anrufs. Teile den Spiellink im Chat. Beide Spieler wählen ihren Zug unabhängig, und das Ergebnis wird gleichzeitig aufgedeckt - kein lautes Zählen bis drei nötig.",
    },
    {
        q: "Können wir Stein Papier Schere auf lange Distanz spielen - in verschiedenen Ländern?",
        a: "Ja. Das Spiel läuft im Browser und funktioniert überall mit Internetverbindung. Kein App-Download oder Konto ist auf keiner Seite nötig. Teile den Link und spiele sofort, egal wo du bist.",
    },
    {
        q: "Wie viele Spiele können wir in einer Sitzung spielen?",
        a: "So viele du möchtest. Der Spielraum bleibt offen und verfolgt die kumulierten Punkte über mehrere Spiele hinweg. Kein neuer Link nötig - einfach weiterspielen, bis einer von euch aufgibt.",
    },
];
...
export function HowItWorks() {
    return (
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                <p>
                    Beide wählen gleichzeitig und sehen die Wahl des anderen nicht, bevor sie bestätigt haben. Jede Partie ist dadurch fair
                    - kein Reagieren im letzten Moment, keine Streitereien.
                </p>
    ...
    return (
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                ...
                <p>
                    Online spielen verhindert Streit darüber, wer was geworfen hat. Beide Züge werden gleichzeitig bestätigt und aufgedeckt.
                </p>
            </div>
        </>
    );
