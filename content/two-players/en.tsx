...
export function HowItWorks() {
    return (
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                <p>
                    Both players pick at the same time and neither can see the other&apos;s choice before locking in. This makes every match
                    genuinely fair - no last-second reactions, no disputes.
                </p>
    ...
    return (
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                ...
                <p>
                    Playing online means no arguments over who threw what. Both choices are locked in and revealed at the same time, every
                    time.
                </p>
            </div>
        </>
