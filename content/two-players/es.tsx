...
export const faqItems: FaqItem[] = [
    ...
    {
        q: "¿Podemos jugar desde diferentes dispositivos?",
        a: "Sí. Un jugador en escritorio, el otro en un teléfono - funciona en cualquier dispositivo con un navegador.",
    },
    {
        q: "¿Puede algún jugador ver el movimiento del otro antes de elegir?",
        a: "No. Ambas elecciones están ocultas hasta que ambos jugadores terminen. Sin miradas, sin trampas.",
    },
    {
        q: "¿Qué pasa si cierro el navegador en medio del juego?",
        a: "Tu sala de juego permanece abierta. Vuelve a abrir el enlace y continúa donde lo dejaste.",
    },
    { q: "¿Puedo jugar en móvil?", a: "Sí. El juego funciona en cualquier smartphone o tableta." },
    {
        q: "¿Podemos usar Piedra Papel Tijeras para resolver una apuesta o tomar una decisión?",
        a: "Sí. Jugar online es más justo que en persona - ambas elecciones se confirman antes de que cualquier jugador vea el resultado, por lo que nadie puede cambiar su movimiento en el último segundo. Es el mismo principio que el lanzamiento de una moneda, excepto que ambos jugadores participan activamente.",
    },
    {
        q: "¿Podemos jugar Piedra Papel Tijeras en una videollamada de Zoom?",
        a: "Sí. Abre el juego en tu propio dispositivo mientras estás en la llamada. Comparte el enlace del juego en el chat. Ambos jugadores eligen su movimiento de forma independiente y el resultado se revela al mismo tiempo - sin necesidad de contar hasta tres en voz alta.",
    },
    {
        q: "¿Podemos jugar Piedra Papel Tijeras a larga distancia - en diferentes países?",
        a: "Sí. El juego funciona en el navegador y en cualquier lugar con conexión a internet. No se necesita descarga de aplicación ni cuenta en ninguno de los lados. Comparte el enlace y juega al instante, independientemente de la ubicación.",
    },
    {
        q: "¿Cuántas partidas podemos jugar en una sesión?",
        a: "Las que quieras. La sala de juego permanece abierta y registra las puntuaciones acumuladas en varias partidas. No es necesario crear un nuevo enlace cada vez - simplemente sigue jugando hasta que uno de vosotros abandone.",
    },
];
...
export function HowItWorks() {
    return (
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                <p>
                    Ambos jugadores eligen al mismo tiempo y ninguno puede ver la elección del otro antes de confirmar. Esto hace que cada
                    partida sea genuinamente justa - sin reacciones de último segundo, sin disputas.
                </p>
                <ul className="list-disc pl-4 space-y-2">
                    <li>El jugador que gane más rondas gana la partida. El primero en ganar 2 se lleva la victoria.</li>
                    <li>
                        Las puntuaciones se rastrean en múltiples partidas en la misma sala - sin necesidad de crear un nuevo enlace cada
                        vez.
                    </li>
                </ul>
            </div>
...
export function WhySettle() {
    return (
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                <p>
                    Piedra Papel Tijeras da a ambos jugadores las mismas posibilidades y se juega en segundos. La gente lo usa para decidir:
                </p>
                ...
                <p>
                    Jugar online significa no tener discusiones sobre quién lanzó qué. Ambas elecciones se confirman y revelan al mismo
                    tiempo, siempre.
                </p>
            </div>
        </>
