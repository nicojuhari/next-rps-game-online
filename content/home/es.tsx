...
export const faqItems: FaqItem[] = [
    {
        q: "¿Qué vence a Piedra en Piedra Papel Tijeras?",
        a: "Papel vence a Piedra. Papel cubre simbólicamente a Piedra, convirtiéndolo en el movimiento ganador cuando tu oponente lanza Piedra.",
    },
    {
        q: "¿Qué vence a Papel?",
        a: "Tijeras vence a Papel. Tijeras corta Papel, convirtiéndolo en el contraataque cuando tu oponente juega Papel.",
    },
    {
        q: "¿Qué vence a Tijeras?",
        a: "Piedra vence a Tijeras. Piedra aplasta Tijeras, convirtiéndolo en el movimiento ganador cuando tu oponente lanza Tijeras.",
    },
    {
        q: "¿Piedra Papel Tijeras es solo suerte?",
        a: "No del todo. Un jugador aleatorio gana el 33% del tiempo, pero las personas reales siguen patrones - y los patrones se pueden leer.",
    },
    {
        q: "¿Necesito registrarme o descargar algo?",
        a: "No. El juego funciona completamente en tu navegador. Sin cuenta, sin descarga, sin aplicación - solo abre la página y juega al instante.",
    },
    {
        q: "¿Funciona en móvil?",
        a: "Sí. El juego es completamente responsivo y funciona en cualquier smartphone o tableta con un navegador moderno.",
    },
    {
        q: "¿Cuál es el mejor primer movimiento?",
        a: "Estadísticamente, Papel es una buena apertura. La mayoría de los jugadores - especialmente los principiantes - lanzan Piedra primero porque parece el movimiento más fuerte. Jugar Papel contrarresta esa tendencia y te da una ventaja estadística en la primera ronda.",
    },
    {
        q: "¿Puedo jugar Piedra Papel Tijeras online con alguien de otro país?",
        a: "Sí. El juego funciona en cualquier navegador, en cualquier lugar. Comparte el enlace y ambos jugadores pueden unirse desde cualquier país, cualquier dispositivo, sin aplicación ni cuenta requerida.",
    },
    {
        q: "¿Cómo elige la computadora su movimiento? ¿Está trucado?",
        a: "La computadora elige aleatoriamente cada vez - Piedra, Papel y Tijeras tienen cada uno una probabilidad igual de 1 en 3. No hay patrón, no hay ajuste según tu historial, y no hay trucos.",
    },
    {
        q: "¿Es mejor jugar Piedra Papel Tijeras online que por mensaje?",
        a: "Sí, porque ambos jugadores revelan su movimiento exactamente al mismo tiempo. En un juego por mensaje, un jugador puede retrasar su respuesta para reaccionar a la elección del otro. Online, ambos movimientos se confirman y revelan simultáneamente - sin mirar, sin trampa.",
    },
];
    ...
    return (
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                ...
                <p>
                    Pon la estrategia a prueba - gana más partidas que tu oponente y podrás reclamar un certificado de ganador personalizado
        ...
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                <p>
                    ...
                    se decide por un conjunto simple de reglas:
                </p>
                ...
                <p>
                    ...
                    una ronda y la tercera es empate, la partida termina empatada.
                </p>
                <p>
...
export function Statistics() {
    return (
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                <p>
                    En un juego perfectamente aleatorio, cada lanzamiento tiene una probabilidad igual de 1 en 3 (33,3%) de ganar, perder o
                    empatar.
                </p>
                <p>
                ...
                <ul className="list-disc pl-4 space-y-1">
                    ...
                    <li>
                        Christie&apos;s pidió consejo a las hijas gemelas de 11 años de uno de sus directores. Las niñas razonaron:
                        &ldquo;Todos piensan que Piedra es el movimiento fuerte. Sotheby&apos;s esperará Piedra, así que jugarán Papel.
                        Jueguen Tijeras.&rdquo;
                    </li>
                </ul>
                <p>
                    Christie&apos;s jugó Tijeras. Sotheby&apos;s jugó Papel. Christie&apos;s ganó - demostrando que incluso en un juego
                    simple, la psicología supera al puro azar.
                </p>
            </div>
        </>
    );
    ...
    return (
        <>
            ...
            <div className="space-y-2 text-sm text-gray-600">
                ...
                <p>
                    Llegó a Japón como <em>Jan-Ken</em>, donde se convirtió en una herramienta social diaria para resolver disputas en
                    escuelas y negocios. Llegó a Occidente a principios del siglo XX y se convirtió en el juego de decisión rápida estándar
                    que es hoy. Hoy tiene muchos nombres: <em>roshambo</em> en EE.UU., piedra papel tijeras en países de habla hispana -
                ...
                <p>
                    La computadora en este sitio elige aleatoriamente - tiene una probabilidad igual de 1 en 3 de lanzar Piedra, Papel o
                    Tijeras cada vez. Sin trucos, solo azar.
                </p>
                <p>
                    Jugar online también elimina la principal forma de hacer trampa en un juego físico. En persona, un jugador puede
                    retrasar su lanzamiento una fracción de segundo para reaccionar a la mano del oponente - una técnica llamada
                    &ldquo;sombreado&rdquo;. En rps-game.online, ambos jugadores confirman su elección en privado antes de que se muestre
                    algún resultado, para que cada partida sea genuinamente justa.
                </p>
            </div>
        </>
    );
...
export function BlogLinks() {
    const posts = [
        { href: "/blog/how-to-win-rock-paper-scissors", title: "Cómo ganar en piedra papel tijeras: estrategia y psicología" },
        { href: "/blog/rock-paper-scissors-rules", title: "Reglas de Piedra Papel Tijeras: La Guía Completa" },
        {
        ...
        { href: "/blog/rock-paper-scissors-long-distance-couples", title: "Piedra Papel Tijera para Parejas a Distancia" },
        { href: "/blog/rock-paper-scissors-vs-coin-flip", title: "Piedra Papel Tijera vs Cara o Cruz: ¿Cuál Es Más Justo?" },
        { href: "/blog/rock-paper-scissors-online-with-friends", title: "Cómo jugar piedra papel tijeras online con amigos" },
    ];
    return (
        <div className="mt-8 pt-6 border-t border-gray-100">
            <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Del Blog</h2>
