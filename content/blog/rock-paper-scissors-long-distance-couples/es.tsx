    ...
    return (
        <article className="text-gray-600 leading-relaxed">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Instantáneo:</strong> sin app, sin registro, sin esperas. Una pareja crea la sala,
                    comparte el enlace y en menos de 60 segundos estáis jugando.
                </li>
                <li>
                    <strong className="text-gray-900">Sin presión:</strong> si pierdes a las 11 de la noche puedes culpar a la mala suerte y
                    pedir la revancha.
                </li>
                <li>
                    <strong className="text-gray-900">Realmente útil:</strong> úsalo para decidir quién elige la película de esta noche,
                    quién manda el primer mensaje mañana, o quién organiza la próxima visita.
                </li>
                <li>
                    <strong className="text-gray-900">Ligeramente competitivo:</strong> crea un momento de drama y un ganador claro - sin la
                    situación ambigua de &ldquo;tú decides&rdquo;.
                </li>
                <li>
                    <strong className="text-gray-900">Funciona en cualquier dispositivo:</strong> teléfono, tablet, portátil - tu pareja no
            ...
            <div className="space-y-3 mb-6">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Envía el enlace a tu pareja</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Tu pareja lo abre en su dispositivo</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Los dos eligen a la vez</p>
                        <p className="text-sm text-gray-600 mt-0.5">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Envía el enlace a tu pareja ahora mismo.</p>
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">El juego de las decisiones</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">La edición de los retos</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">El marcador acumulado</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">El calentamiento previo a la cita</h3>
            <p className="mb-4">
            ...
            <div className="space-y-5">
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Se puede jugar piedra papel tijera a larga distancia?</h3>
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Cómo se juega de forma justa en videollamada?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Necesitamos los dos una cuenta?</h3>
                    <p className="text-gray-600">No. Sin correo, sin contraseña, sin cuenta. Abre el enlace y juega.</p>
                </div>
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Qué pasa si estamos en países diferentes?</h3>
                    <p className="text-gray-600">
                        Funciona desde cualquier lugar con internet - cualquier país, cualquier zona horaria, cualquier dispositivo.
                    </p>
                </div>
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Se puede jugar más de una ronda?</h3>
                    <p className="text-gray-600">
                        Sí - cada sesión es al mejor de 3. Jugad tantas sesiones como queráis y llevad vuestro propio marcador acumulado.
                    </p>
                </div>
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Qué juegos gratis pueden jugar dos personas sin descargar nada?</h3>
                    <p className="text-gray-600">
            ...
            <div className="border-t border-gray-200 mt-10 pt-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">¿Listos para jugar?</p>
