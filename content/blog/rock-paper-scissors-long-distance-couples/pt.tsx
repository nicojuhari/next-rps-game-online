    ...
    return (
        <article className="text-gray-600 leading-relaxed">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Instantâneo:</strong> sem app, sem cadastro, sem espera. Um parceiro cria a sala,
                    compartilha o link e em menos de 60 segundos vocês estão jogando.
                </li>
                <li>
                    <strong className="text-gray-900">Sem pressão:</strong> se você perder às 23h pode culpar o azar e exigir a revanche.
                </li>
                <li>
                    <strong className="text-gray-900">Realmente útil:</strong> use para decidir quem escolhe o filme de hoje, quem manda a
                    primeira mensagem amanhã, ou quem organiza a próxima visita.
                </li>
                <li>
                    <strong className="text-gray-900">Levemente competitivo:</strong> cria um momento de drama e um vencedor claro - sem o
                    &ldquo;você decide&rdquo; ambíguo.
                </li>
                <li>
                    <strong className="text-gray-900">Funciona em qualquer dispositivo:</strong> celular, tablet, notebook - seu parceiro
            ...
            <div className="space-y-3 mb-6">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Envie o link para seu parceiro</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Seu parceiro abre no dispositivo dele</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Os dois escolhem ao mesmo tempo</p>
                        <p className="text-sm text-gray-600 mt-0.5">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Mande o link para seu parceiro agora.</p>
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">O jogo das decisões</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">A edição dos desafios</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">O placar acumulado</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">O aquecimento antes do encontro</h3>
            <p className="mb-4">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                <p className="text-sm text-gray-600 font-medium mb-1">Funciona em qualquer dispositivo - sem app, sem conta, só um link.</p>
            ...
            <div className="space-y-5">
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Dá para jogar pedra papel tesoura à distância?</h3>
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Como jogar de forma justa em videochamada?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Precisamos de uma conta?</h3>
                    <p className="text-gray-600">Não. Sem e-mail, sem senha, sem conta. Abra o link e jogue.</p>
                </div>
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">E se estivermos em países diferentes?</h3>
                    <p className="text-gray-600">
                        Funciona de qualquer lugar com internet - qualquer país, qualquer fuso horário, qualquer dispositivo.
                    </p>
                </div>
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Dá para jogar mais de uma rodada?</h3>
                    <p className="text-gray-600">
                        Sim - cada sessão é melhor de 3. Jogue quantas sessões quiser e mantenha seu próprio placar acumulado.
                    </p>
                </div>
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Quais jogos gratuitos dois podem jogar sem baixar nada?</h3>
                    <p className="text-gray-600">
            ...
            <div className="border-t border-gray-200 mt-10 pt-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Prontos para jogar?</p>
