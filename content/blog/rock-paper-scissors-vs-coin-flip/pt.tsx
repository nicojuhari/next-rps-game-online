    ...
    return (
        <article className="text-gray-600 leading-relaxed">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Agência:</strong> os dois jogadores fazem uma escolha ativa. Mesmo que o resultado
                    seja aleatório, não parece arbitrário - você jogou por isso.
                </li>
                <li>
                    <strong className="text-gray-900">Menor variância:</strong> o formato melhor de 3 torna o resultado mais estável do que
                    um único lançamento de moeda.
                </li>
                <li>
                    <strong className="text-gray-900">Revelação simultânea:</strong> quando jogado corretamente, nenhum jogador pode ver a
                    escolha do outro antes de se comprometer.
                </li>
                <li>
                    <strong className="text-gray-900">Mais satisfatório:</strong> o perdedor escolheu sua jogada - não pode culpar apenas a
                ...
                <table className="w-full text-sm border-collapse">
                    <thead>
                        <tr className="bg-gray-100 text-gray-600">
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Fator</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Cara ou Coroa</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Pedra Papel Tesoura</th>
                        </tr>
                    </thead>
                    <tbody className="text-gray-600">
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Probabilidade base</td>
                            <td className="p-3 border-b border-gray-200">50/50</td>
                            <td className="p-3 border-b border-gray-200">50/50</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Agência do jogador</td>
                            <td className="p-3 border-b border-gray-200">Nenhuma</td>
                            <td className="p-3 border-b border-gray-200">Alta</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Variância por decisão</td>
                            <td className="p-3 border-b border-gray-200">Um lançamento</td>
                            <td className="p-3 border-b border-gray-200">Melhor de 3 (menor variância)</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Componente de habilidade</td>
                            <td className="p-3 border-b border-gray-200">Nenhum</td>
                            <td className="p-3 border-b border-gray-200">Pequeno (vs humanos)</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Risco de trapaça (presencial)</td>
                            <td className="p-3 border-b border-gray-200">Baixo</td>
                            <td className="p-3 border-b border-gray-200">Baixo (revelação simultânea)</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">
                                Risco de trapaça (remoto, por mensagem)
                            </td>
                            <td className="p-3 border-b border-gray-200">Baixo</td>
                            <td className="p-3 border-b border-gray-200 text-amber-700 font-medium">
                                Alto - o segundo a revelar pode ajustar
                            </td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Risco de trapaça (online, tempo real)</td>
                            <td className="p-3 border-b border-gray-200">N/A</td>
                            <td className="p-3 border-b border-gray-200 text-green-700 font-medium">Nenhum - revelação simultânea forçada</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Fator diversão</td>
                            <td className="p-3 border-b border-gray-200">Baixo</td>
                            <td className="p-3 border-b border-gray-200">Alto</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Tempo até o resultado</td>
                            <td className="p-3 border-b border-gray-200">5 segundos</td>
                            <td className="p-3 border-b border-gray-200">30-60 segundos</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Precisa resolver algo agora?</p>
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Você precisa de uma resposta instantânea</strong> - sem tempo para 3 rodadas, só um
                    resultado em 5 segundos.
                </li>
                <li>
                    <strong className="text-gray-900">As duas partes querem zero agência</strong> - às vezes ninguém quer o peso de ter
                    escolhido.
                </li>
                <li>
                    <strong className="text-gray-900">Há uma diferença de habilidade</strong> - se um conhece a estratégia de PPT e o outro
                    não, cara ou coroa restaura o terreno nivelado.
                </li>
                <li>
                    <strong className="text-gray-900">Você está sozinho e reportando o resultado</strong> - cara ou coroa é mais fácil de
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Você quer que o resultado pareça conquistado</strong> - os dois escolheram. O perdedor
                    não pode atribuir ao azar.
                </li>
                <li>
                    <strong className="text-gray-900">A variância importa</strong> - melhor de 3 produz um resultado mais confiável do que
                    um único lançamento.
                </li>
                <li>
                    <strong className="text-gray-900">Você quer algum drama</strong> - três rodadas de tensão superam um único lançamento em
                    entretenimento.
                </li>
                <li>
                    <strong className="text-gray-900">Você está fazendo remotamente</strong> - revelar por mensagem é passível de trapaça.
            ...
            <div className="space-y-3 mb-6">
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Abra o jogo para 2 jogadores e crie uma sala</p>
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Compartilhe o link</p>
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Os dois escolhem simultaneamente</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">O vencedor ganha, a disputa resolvida</p>
                        <p className="text-sm text-gray-600 mt-0.5">
            ...
            <div className="space-y-5">
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">PPT é realmente 50/50?</h3>
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Cara ou coroa é mais aleatório que PPT?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Dá para trapacear no PPT online?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">E se os dois conhecerem a estratégia?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Qual é uma forma justa de decidir entre duas pessoas?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Como resolver uma discussão de forma justa online?</h3>
                    <p className="text-gray-600">
            ...
            <div className="border-t border-gray-200 mt-10 pt-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Da próxima vez que precisar decidir algo, pule o cara ou coroa.</p>
