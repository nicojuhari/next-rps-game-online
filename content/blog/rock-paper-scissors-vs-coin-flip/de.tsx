    ...
    return (
        <article className="text-gray-600 leading-relaxed">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Handlungsspielraum:</strong> beide Spieler treffen eine aktive Wahl. Auch wenn das
                    Ergebnis zufällig ist, wirkt es nicht willkürlich - du hast dafür gespielt.
                </li>
                <li>
                    <strong className="text-gray-900">Geringere Varianz:</strong> das Best-of-3-Format macht das Ergebnis stabiler als ein
                    einzelner Münzwurf.
                </li>
                <li>
                    <strong className="text-gray-900">Simultane Enthüllung:</strong> richtig gespielt, kann keiner den Zug des anderen
                    sehen, bevor er sich festlegt.
                </li>
                <li>
                    <strong className="text-gray-900">Befriedigender:</strong> der Verlierer hat seinen Zug gewählt - er kann nicht nur die
                ...
                <table className="w-full text-sm border-collapse">
                    <thead>
                        <tr className="bg-gray-100 text-gray-600">
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Faktor</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Münzwurf</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Schere Stein Papier</th>
                        </tr>
                    </thead>
                    <tbody className="text-gray-600">
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Grundwahrscheinlichkeit</td>
                            <td className="p-3 border-b border-gray-200">50/50</td>
                            <td className="p-3 border-b border-gray-200">50/50</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Handlungsspielraum</td>
                            <td className="p-3 border-b border-gray-200">Keiner</td>
                            <td className="p-3 border-b border-gray-200">Hoch</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Varianz pro Entscheidung</td>
                            <td className="p-3 border-b border-gray-200">Ein Wurf</td>
                            <td className="p-3 border-b border-gray-200">Best-of-3 (geringere Varianz)</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Skillkomponente</td>
                            <td className="p-3 border-b border-gray-200">Keine</td>
                            <td className="p-3 border-b border-gray-200">Klein (vs. Menschen)</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Betrugsrisiko (persönlich)</td>
                            <td className="p-3 border-b border-gray-200">Niedrig</td>
                            <td className="p-3 border-b border-gray-200">Niedrig (simultane Enthüllung)</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Betrugsrisiko (Fern, per Nachricht)</td>
                            <td className="p-3 border-b border-gray-200">Niedrig</td>
                        ...
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Betrugsrisiko (online, Echtzeit)</td>
                        ...
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Spaßfaktor</td>
                            <td className="p-3 border-b border-gray-200">Niedrig</td>
                            <td className="p-3 border-b border-gray-200">Hoch</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Zeit bis Ergebnis</td>
                            <td className="p-3 border-b border-gray-200">5 Sekunden</td>
                            <td className="p-3 border-b border-gray-200">30-60 Sekunden</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Musst du jetzt gerade etwas entscheiden?</p>
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Du brauchst eine sofortige Antwort</strong> - keine Zeit für 3 Runden, nur ein
                    Ergebnis in 5 Sekunden.
                </li>
                <li>
                    <strong className="text-gray-900">Beide Parteien wollen keinen Handlungsspielraum</strong> - manchmal will niemand das
                    Gewicht der Entscheidung tragen.
                </li>
                <li>
                    <strong className="text-gray-900">Es gibt ein Skill-Gefälle</strong> - wenn einer SSP-Strategie kennt und der andere
                    nicht, stellt ein Münzwurf das Gleichgewicht wieder her.
                </li>
                <li>
                    <strong className="text-gray-900">Du bist allein und berichtest das Ergebnis</strong> - ein Münzwurf ist einfacher
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Das Ergebnis soll verdient wirken</strong> - beide haben ihren Zug gewählt. Der
                    Verlierer kann es nicht nur dem Zufall zuschreiben.
                </li>
                <li>
                    <strong className="text-gray-900">Varianz ist wichtig</strong> - Best-of-3 liefert ein zuverlässigeres Ergebnis als ein
                    einzelner Wurf.
                </li>
                <li>
                    <strong className="text-gray-900">Du willst etwas Spannung</strong> - drei Runden Aufbau schlagen einen einzelnen Wurf
                    in Sachen Unterhaltung.
                </li>
                <li>
                    <strong className="text-gray-900">Du machst es aus der Ferne</strong> - Züge per Nachricht teilen ist betrugsanfällig.
            ...
            <div className="space-y-3 mb-6">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Link teilen</p>
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Beide Spieler wählen simultan</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Gewinner gewinnt, Streit beigelegt</p>
                        <p className="text-sm text-gray-600 mt-0.5">
            ...
            <div className="space-y-5">
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Ist Schere Stein Papier wirklich 50/50?</h3>
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Ist ein Münzwurf zufälliger als SSP?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Kann man bei Online-SSP betrügen?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Was, wenn beide SSP-Strategie kennen?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Was ist eine faire Methode, zwischen zwei Personen zu entscheiden?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Wie beilegt man einen Streit fair online?</h3>
                    <p className="text-gray-600">
