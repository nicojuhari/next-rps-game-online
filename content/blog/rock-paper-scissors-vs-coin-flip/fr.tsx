    ...
    return (
        <article className="text-gray-600 leading-relaxed">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Agentivité :</strong> les deux joueurs font un choix actif. Même si le résultat est
                    aléatoire, il ne semble pas arbitraire - vous avez joué pour ça.
                </li>
                <li>
                    <strong className="text-gray-900">Variance réduite :</strong> le format meilleur des 3 rend le résultat plus stable
                ...
                <li>
                    <strong className="text-gray-900">Révélation simultanée :</strong> joué correctement, aucun joueur ne peut voir le choix
                    de l&apos;autre avant de s&apos;engager. Personne ne peut prétendre qu&apos;il &ldquo;aurait choisi autrement&rdquo;.
                </li>
                <li>
                    <strong className="text-gray-900">Plus satisfaisant :</strong> le perdant a choisi son geste - il ne peut pas accuser la
                ...
                <table className="w-full text-sm border-collapse">
                    <thead>
                        <tr className="bg-gray-100 text-gray-600">
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Critère</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Pile ou face</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Pierre Feuille Ciseaux</th>
                        </tr>
                    </thead>
                    <tbody className="text-gray-600">
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Probabilité de base</td>
                            <td className="p-3 border-b border-gray-200">50/50</td>
                            <td className="p-3 border-b border-gray-200">50/50</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Agentivité du joueur</td>
                            <td className="p-3 border-b border-gray-200">Aucune</td>
                            <td className="p-3 border-b border-gray-200">Élevée</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Variance par décision</td>
                            <td className="p-3 border-b border-gray-200">Un seul lancer</td>
                            <td className="p-3 border-b border-gray-200">Meilleur des 3 (variance réduite)</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Composante de compétence</td>
                            <td className="p-3 border-b border-gray-200">Aucune</td>
                            <td className="p-3 border-b border-gray-200">Faible (face aux humains)</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Risque de triche (en personne)</td>
                            <td className="p-3 border-b border-gray-200">Faible</td>
                            <td className="p-3 border-b border-gray-200">Faible (révélation simultanée)</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Risque de triche (à distance, SMS)</td>
                            <td className="p-3 border-b border-gray-200">Faible</td>
                        ...
                        <tr>
                            ...
                            <td className="p-3 border-b border-gray-200 text-green-700 font-medium">Aucun - révélation simultanée imposée</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Facteur plaisir</td>
                            <td className="p-3 border-b border-gray-200">Faible</td>
                            <td className="p-3 border-b border-gray-200">Élevé</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Durée</td>
                            <td className="p-3 border-b border-gray-200">5 secondes</td>
                            <td className="p-3 border-b border-gray-200">30-60 secondes</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Besoin de trancher quelque chose maintenant ?</p>
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Vous avez besoin d&apos;une réponse immédiate</strong> - pas le temps pour un match en
                    3 manches, vous avez juste besoin d&apos;un résultat en 5 secondes.
                </li>
                <li>
                    <strong className="text-gray-900">Les deux parties veulent zéro agentivité</strong> - parfois les gens ne veulent
                    vraiment pas avoir le poids d&apos;avoir choisi. Pile ou face supprime cela entièrement.
                </li>
                <li>
                    <strong className="text-gray-900">Il y a un écart de compétence</strong> - si l&apos;un connaît la stratégie PFC et
                    l&apos;autre non, le jeu n&apos;est plus 50/50. Pile ou face rétablit le terrain nivelé.
                </li>
                <li>
                    <strong className="text-gray-900">Vous êtes seul et annoncez le résultat</strong> - pile ou face est plus facile à faire
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Vous voulez que le résultat semble mérité</strong> - les deux parties ont choisi leur
                    geste. Le perdant ne peut pas attribuer le résultat à la seule malchance.
                </li>
                <li>
                    <strong className="text-gray-900">La variance compte</strong> - le meilleur des 3 produit un résultat plus fiable
                    qu&apos;un seul lancer. Pour les décisions où un seul flip semble trop arbitraire, PFC offre un meilleur échantillon.
                </li>
                <li>
                    <strong className="text-gray-900">Vous voulez du suspense</strong> - trois manches de tension battent un seul lancer en
                    termes d&apos;engagement. Il y a une raison pour laquelle le sport utilise le meilleur des 7, pas des pièces de monnaie.
                </li>
                <li>
                    <strong className="text-gray-900">Vous jouez à distance</strong> - envoyer votre choix PFC par SMS est bancal (le second
            ...
            <div className="space-y-3 mb-6">
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Ouvrez la partie à 2 joueurs et créez une salle</p>
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Partagez le lien</p>
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Les deux joueurs choisissent simultanément</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Le gagnant gagne, le désaccord est tranché</p>
                        <p className="text-sm text-gray-600 mt-0.5">
            ...
            <div className="space-y-5">
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Pierre feuille ciseaux est-il vraiment 50/50 ?</h3>
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Pile ou face est-il plus aléatoire que pierre feuille ciseaux ?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Peut-on tricher à pierre feuille ciseaux en ligne ?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Et si les deux joueurs connaissent la stratégie PFC ?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Quelle est la manière équitable de décider entre deux personnes ?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Comment régler équitablement un désaccord en ligne ?</h3>
                    <p className="text-gray-600">
