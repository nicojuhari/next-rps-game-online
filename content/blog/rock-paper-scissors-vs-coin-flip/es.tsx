    ...
    return (
        <article className="text-gray-600 leading-relaxed">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Agencia:</strong> ambos jugadores toman una decisión activa. Aunque el resultado sea
                    aleatorio, no parece arbitrario - lo jugaste.
                </li>
                <li>
                    <strong className="text-gray-900">Menor varianza:</strong> el formato al mejor de 3 hace el resultado más estable que un
                    solo lanzamiento de moneda.
                </li>
                <li>
                    <strong className="text-gray-900">Revelación simultánea:</strong> cuando se juega correctamente, ningún jugador puede
                    ver la elección del otro antes de comprometerse.
                </li>
                <li>
                    <strong className="text-gray-900">Más satisfactorio:</strong> el perdedor eligió su jugada - no puede culpar a la
                ...
                <table className="w-full text-sm border-collapse">
                    <thead>
                        <tr className="bg-gray-100 text-gray-600">
                            ...
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Lanzar moneda</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Piedra Papel Tijera</th>
                        </tr>
                    </thead>
                    <tbody className="text-gray-600">
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Probabilidad base</td>
                            <td className="p-3 border-b border-gray-200">50/50</td>
                            <td className="p-3 border-b border-gray-200">50/50</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Agencia del jugador</td>
                            <td className="p-3 border-b border-gray-200">Ninguna</td>
                            <td className="p-3 border-b border-gray-200">Alta</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Varianza por decisión</td>
                            <td className="p-3 border-b border-gray-200">Un lanzamiento</td>
                            <td className="p-3 border-b border-gray-200">Mejor de 3 (menor varianza)</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Componente de habilidad</td>
                            <td className="p-3 border-b border-gray-200">Ninguno</td>
                            <td className="p-3 border-b border-gray-200">Pequeño (vs humanos)</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Riesgo de trampa (en persona)</td>
                            <td className="p-3 border-b border-gray-200">Bajo</td>
                            <td className="p-3 border-b border-gray-200">Bajo (revelación simultánea)</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Riesgo de trampa (remoto, por mensaje)</td>
                            <td className="p-3 border-b border-gray-200">Bajo</td>
                        ...
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Riesgo de trampa (online, tiempo real)</td>
                        ...
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Factor diversión</td>
                            <td className="p-3 border-b border-gray-200">Bajo</td>
                            <td className="p-3 border-b border-gray-200">Alto</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-medium text-gray-600">Tiempo hasta el resultado</td>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">¿Necesitas resolver algo ahora mismo?</p>
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Necesitas una respuesta instantánea</strong> - sin tiempo para 3 rondas, solo un
                    resultado en 5 segundos.
                </li>
                <li>
                    <strong className="text-gray-900">Ambas partes quieren cero agencia</strong> - a veces nadie quiere la responsabilidad
                    de haber elegido.
                </li>
                <li>
                    <strong className="text-gray-900">Hay una brecha de habilidad</strong> - si uno conoce la estrategia de PPT y el otro
                    no, la moneda restaura el terreno de juego igualado.
                </li>
                <li>
                    <strong className="text-gray-900">Estás solo y reportas el resultado</strong> - la moneda es más fácil de hacer en
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Quieres que el resultado se sienta ganado</strong> - ambas partes eligieron su jugada.
                    El perdedor no puede atribuirlo solo a la mala suerte.
                </li>
                <li>
                    <strong className="text-gray-900">La varianza importa</strong> - el mejor de 3 produce un resultado más fiable que un
                    solo lanzamiento.
                </li>
                <li>
                    <strong className="text-gray-900">Quieres algo de drama</strong> - tres rondas de tensión superan a un solo lanzamiento
                    en entretenimiento.
                </li>
                <li>
                    <strong className="text-gray-900">Lo haces en remoto</strong> - revelar por mensaje es tramposo. Una herramienta online
            ...
            <div className="space-y-3 mb-6">
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Abre el juego para 2 jugadores y crea una sala</p>
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Comparte el enlace</p>
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Los dos eligen simultáneamente</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">El ganador gana, la disputa resuelta</p>
                        <p className="text-sm text-gray-600 mt-0.5">
            ...
            <div className="space-y-5">
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Es piedra papel tijera realmente 50/50?</h3>
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Es lanzar una moneda más aleatorio que PPT?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Se puede hacer trampa en PPT online?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Qué pasa si los dos conocen la estrategia?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Cuál es una forma justa de decidir entre dos personas?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Cómo se resuelve una discusión de forma justa online?</h3>
                    <p className="text-gray-600">
            ...
            <div className="border-t border-gray-200 mt-10 pt-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">La próxima vez que necesites decidir algo, olvida la moneda.</p>
