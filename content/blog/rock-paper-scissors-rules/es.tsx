        ...
        <article className="text-gray-600 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
                    ...
                    <p className="font-semibold text-gray-900">Piedra</p>
                    <p className="text-sm text-gray-400 mt-1">Puño cerrado</p>
                </div>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
                    <div className="text-3xl mb-2">✋</div>
                    <p className="font-semibold text-gray-900">Papel</p>
                    <p className="text-sm text-gray-400 mt-1">Mano abierta y plana</p>
                </div>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
                    <div className="text-3xl mb-2">✌️</div>
                    <p className="font-semibold text-gray-900">Tijeras</p>
                    <p className="text-sm text-gray-400 mt-1">Índice y corazón extendidos en V</p>
                </div>
            </div>
                ...
                <table className="w-full text-sm border-collapse">
                    <thead>
                        <tr className="bg-gray-100 text-gray-600">
                            ...
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Vence a</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Pierde ante</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Por qué</th>
                        </tr>
                    </thead>
                    <tbody className="text-gray-600">
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-semibold text-gray-900">Piedra ✊</td>
                            <td className="p-3 border-b border-gray-200">Tijeras ✌️</td>
                            <td className="p-3 border-b border-gray-200">Papel ✋</td>
                            <td className="p-3 border-b border-gray-200">Piedra aplasta Tijeras; Papel cubre Piedra</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-semibold text-gray-900">Papel ✋</td>
                            <td className="p-3 border-b border-gray-200">Piedra ✊</td>
                            <td className="p-3 border-b border-gray-200">Tijeras ✌️</td>
                            <td className="p-3 border-b border-gray-200">Papel cubre Piedra; Tijeras corta Papel</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-semibold text-gray-900">Tijeras ✌️</td>
                            <td className="p-3 border-b border-gray-200">Papel ✋</td>
                            <td className="p-3 border-b border-gray-200">Piedra ✊</td>
                            <td className="p-3 border-b border-gray-200">Tijeras corta Papel; Piedra aplasta Tijeras</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <p className="mb-4">
                ...
                <strong className="text-gray-900">ambos jugadores deben revelar su gesto exactamente al mismo tiempo.</strong> Ningún
            ...
            <ul className="list-disc pl-5 mb-4 space-y-1">
                <li>
                    <strong className="text-gray-900">Piedra, Papel, Tijeras, ¡Ya!</strong> - se revela en &ldquo;¡Ya!&rdquo;
                </li>
                <li>
                    <strong className="text-gray-900">1, 2, 3, ¡Ahora!</strong> - se revela en &ldquo;¡Ahora!&rdquo;
                </li>
                <li>
                    <strong className="text-gray-900">Jan-ken-pon</strong> - el conteo japonés, se revela en &ldquo;pon&rdquo;
                </li>
            </ul>
            <p className="mb-4">
            ...
            <p className="mb-4">
                ...
                <strong className="text-gray-900">repetir de inmediato</strong>. Seguir repitiendo hasta que el gesto de un jugador venza al
                del otro.
            </p>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Lanzamiento único:</strong> una ronda, decisión inmediata. Se usa para elecciones
                    rápidas como quién paga la cuenta o quién va primero en un juego de mesa.
                </li>
                <li>
                    <strong className="text-gray-900">Mejor de 3:</strong> el primer jugador en ganar 2 rondas gana el partido. El formato
                    competitivo estándar y el que se usa en este sitio.
                </li>
                <li>
                    <strong className="text-gray-900">Mejor de 5:</strong> el primero en ganar 3. Se usa cuando se necesita un partido más
                    largo - más rondas reduce la influencia de un lanzamiento afortunado y da más espacio a la estrategia.
                </li>
                <li>
                    <strong className="text-gray-900">Rondas fijas:</strong> un número determinado de rondas (ej. 10), ganando quien acumule
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">¿Listo para jugar?</p>
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Piedra Papel Tijeras Lagarto Spock</strong> - popularizado por The Big Bang Theory.
                ...
                <li>
                    <strong className="text-gray-900">Torneo de PPT</strong> - gobernado por la World RPS Society, que publica reglas
            ...
            <ul className="list-disc pl-5 mb-4 space-y-1">
                <li>
                    <strong className="text-gray-900">Jan-ken-pon</strong> (Japón) - considerada la forma documentada más antigua, del siglo
                    XVII
                </li>
                <li>
                    <strong className="text-gray-900">Roshambo / Rochambeau</strong> (EE.UU.) - origen debatido, muy usado en el oeste
                    americano
                </li>
                <li>
                    <strong className="text-gray-900">Ching chong cha</strong> (Sudáfrica)
                </li>
                <li>
                    <strong className="text-gray-900">Schnick, Schnack, Schnuck</strong> (Alemania)
                </li>
                <li>
                    <strong className="text-gray-900">Pierre, feuille, ciseaux</strong> (Francia)
                </li>
            </ul>
            ...
            <div className="space-y-5">
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Cuáles son las reglas oficiales de piedra papel tijeras?</h3>
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Qué vence a qué en piedra papel tijeras?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Qué pasa cuando hay empate en piedra papel tijeras?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿De dónde viene piedra papel tijeras?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">¿Qué es roshambo?</h3>
                    <p className="text-gray-600">
            ...
            <div className="border-t border-gray-200 mt-10 pt-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Ya conoces las reglas. Ahora juega.</p>
                <p className="text-sm text-gray-400 mb-5">Desafía a un amigo en línea - sin cuenta, solo comparte el enlace.</p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <CtaLink href="/two-players" className="text-sm px-5 py-2.5">
                        Jugar con un Amigo →
                    </CtaLink>
