        ...
        <article className="text-gray-600 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
                    ...
                    <p className="font-semibold text-gray-900">Pierre</p>
                    <p className="text-sm text-gray-400 mt-1">Poing fermé</p>
                </div>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
                    <div className="text-3xl mb-2">✋</div>
                    <p className="font-semibold text-gray-900">Feuille</p>
                    <p className="text-sm text-gray-400 mt-1">Main ouverte et plate</p>
                </div>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
                    <div className="text-3xl mb-2">✌️</div>
                    <p className="font-semibold text-gray-900">Ciseaux</p>
                    <p className="text-sm text-gray-400 mt-1">Index et majeur étendus en V</p>
                </div>
            </div>
                ...
                <table className="w-full text-sm border-collapse">
                    <thead>
                        <tr className="bg-gray-100 text-gray-600">
                            ...
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Bat</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Perd contre</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Pourquoi</th>
                        </tr>
                    </thead>
                    <tbody className="text-gray-600">
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-semibold text-gray-900">Pierre ✊</td>
                            <td className="p-3 border-b border-gray-200">Ciseaux ✌️</td>
                            <td className="p-3 border-b border-gray-200">Feuille ✋</td>
                            <td className="p-3 border-b border-gray-200">Pierre écrase Ciseaux ; Feuille couvre Pierre</td>
                        </tr>
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200 font-semibold text-gray-900">Feuille ✋</td>
                            <td className="p-3 border-b border-gray-200">Pierre ✊</td>
                            <td className="p-3 border-b border-gray-200">Ciseaux ✌️</td>
                            <td className="p-3 border-b border-gray-200">Feuille couvre Pierre ; Ciseaux coupe Feuille</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-semibold text-gray-900">Ciseaux ✌️</td>
                            <td className="p-3 border-b border-gray-200">Feuille ✋</td>
                            <td className="p-3 border-b border-gray-200">Pierre ✊</td>
                            <td className="p-3 border-b border-gray-200">Ciseaux coupe Feuille ; Pierre écrase Ciseaux</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <p className="mb-4">
                ...
                <strong className="text-gray-900">les deux joueurs doivent révéler leur geste exactement au même moment.</strong> Aucun
            ...
            <ul className="list-disc pl-5 mb-4 space-y-1">
                <li>
                    <strong className="text-gray-900">Pierre, Feuille, Ciseaux, Allez !</strong> - révéler sur &ldquo;Allez !&rdquo;
                </li>
                <li>
                    <strong className="text-gray-900">1, 2, 3, Partez !</strong> - révéler sur &ldquo;Partez !&rdquo;
                </li>
                <li>
                    <strong className="text-gray-900">Jan-ken-pon</strong> - le décompte japonais, révéler sur &ldquo;pon&rdquo;
                </li>
            </ul>
            <p className="mb-4">
            ...
            <p className="mb-4">
                ...
                <strong className="text-gray-900">rejouer immédiatement</strong>. Continuer à rejouer jusqu&apos;à ce que le geste d&apos;un
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Lancer unique :</strong> une manche, décision immédiate. Utilisé pour des choix
                    rapides comme qui paie l&apos;addition ou qui commence dans un jeu de société.
                </li>
                <li>
                    <strong className="text-gray-900">Meilleur des 3 :</strong> le premier joueur à gagner 2 manches remporte le match. Le
                    format compétitif standard et celui utilisé sur ce site.
                </li>
                <li>
                    <strong className="text-gray-900">Meilleur des 5 :</strong> le premier à 3 victoires. Utilisé quand un match plus long
                    est souhaité - plus de manches réduit l&apos;influence d&apos;un lancer chanceux.
                </li>
                <li>
                    <strong className="text-gray-900">Manches fixes :</strong> un nombre défini de manches (ex. 10), le joueur avec le plus
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Prêt à jouer ?</p>
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Pierre Feuille Ciseaux Lézard Spock</strong> - popularisé par The Big Bang Theory.
                ...
                <li>
                    <strong className="text-gray-900">Tournoi de PFC</strong> - régi par la World RPS Society, qui publie des règles
            ...
            <ul className="list-disc pl-5 mb-4 space-y-1">
                <li>
                    <strong className="text-gray-900">Jan-ken-pon</strong> (Japon) - considérée comme la forme documentée la plus ancienne,
                    datant du XVIIe siècle
                </li>
                <li>
                    <strong className="text-gray-900">Roshambo / Rochambeau</strong> (États-Unis) - origine débattue, très répandu dans
                    l&apos;ouest américain
                </li>
                <li>
                    <strong className="text-gray-900">Ching chong cha</strong> (Afrique du Sud)
                </li>
                <li>
                    <strong className="text-gray-900">Piedra, papel o tijeras</strong> (monde hispanophone)
                </li>
                <li>
                    <strong className="text-gray-900">Schnick, Schnack, Schnuck</strong> (Allemagne)
                </li>
            </ul>
            ...
            <div className="space-y-5">
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Quelles sont les règles officielles de pierre feuille ciseaux ?</h3>
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Qu&apos;est-ce qui bat quoi à pierre feuille ciseaux ?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Que se passe-t-il en cas d&apos;égalité ?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Combien de manches dure une partie standard ?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">D&apos;où vient pierre feuille ciseaux ?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Qu&apos;est-ce que le roshambo ?</h3>
                    <p className="text-gray-600">
            ...
            <div className="border-t border-gray-200 mt-10 pt-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Vous connaissez les règles. Maintenant jouez.</p>
                <p className="text-sm text-gray-400 mb-5">Défiez un ami en ligne - sans compte, juste un lien à partager.</p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <CtaLink href="/two-players" className="text-sm px-5 py-2.5">
                        Jouer avec un Ami →
                    </CtaLink>
