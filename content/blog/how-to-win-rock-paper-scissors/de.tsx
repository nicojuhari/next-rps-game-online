...
export const meta: BlogPostMeta = {
    title: "Schere Stein Papier gewinnen: Psychologie, Strategie und Forschung",
    description:
        "Die meisten Menschen behandeln Schere Stein Papier als reines Glücksspiel. Forscher sehen das anders. Lerne die Verhaltensmuster, Statistiken und die rundenweise Strategie, die dir einen echten Vorteil verschaffen.",
    ...
    return (
        <article className="text-gray-700 leading-relaxed">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-1">
                <li><strong className="text-gray-800">Stein: ~35%</strong> — der häufigste Zug, deutlich über den erwarteten 33,3%</li>
                <li><strong className="text-gray-800">Schere: ~35%</strong> — fast gleichauf mit Stein</li>
                <li><strong className="text-gray-800">Papier: ~29,6%</strong> — der seltenste Zug</li>
            </ul>
            <p className="mb-4">
            ...
            <p className="mb-4">
                Das erklärt auch die berühmte Auktion von 2005 zwischen Christie&apos;s und Sotheby&apos;s. Mit 17,8 Millionen Dollar auf dem Spiel bat Christie&apos;s ein 11-jähriges Mädchen um Rat. Sie überlegte: &ldquo;Alle denken, Stein ist der starke Zug. Sie werden Papier spielen, um ihn zu schlagen. Wir spielen Schere.&rdquo; Christie&apos;s gewann.
            </p>

            {/* Section 3 */}
            <h2 className="text-xl font-bold mt-10 mb-3 text-gray-900">Das Gewinner-Bleiben, Verlierer-Wechseln-Muster</h2>
            <p className="mb-4">
                Der wichtigste Befund der Zhejiang-Studie war ein Verhaltensmuster, das sie <strong className="text-gray-800">Gewinner-Bleiben, Verlierer-Wechseln</strong> nannten:
            </p>
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li><strong className="text-gray-800">Wenn ein Spieler gewinnt:</strong> neigt er dazu, den gerade gewonnenen Zug zu wiederholen</li>
                <li><strong className="text-gray-800">Wenn ein Spieler verliert:</strong> neigt er dazu, zum nächsten Zug im Uhrzeigersinn zu wechseln: Stein → Papier → Schere → Stein</li>
            </ul>
            <p className="mb-4">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4 text-sm space-y-2">
                ...
                <p className="font-semibold text-gray-800 mt-3">Wenn sie gerade verloren haben (Verlierer-Wechseln — erwarte den nächsten Zug im Zyklus):</p>
                <ul className="list-disc pl-5 space-y-1 text-gray-600">
                ...
                <table className="w-full text-sm border-collapse">
                    ...
                    <tbody className="text-gray-600">
                        ...
                        <tr className="bg-gray-50">
                            ...
                            <td className="p-3 border border-gray-200">Experten erwarten Papier und kontern mit Schere — also matchst du sie</td>
                        </tr>
                        <tr>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">Fordere einen Freund heraus — schau, ob er deine Muster lesen kann, bevor du seine liest.</p>
            ...
            <div className="border-t border-gray-200 mt-10 pt-8 text-center">
                ...
                <p className="text-sm text-gray-500 mb-5">Der einzige Weg, sie zu schärfen, ist gegen jemanden zu spielen, der sie nicht kennt.</p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <CtaLink href="/two-players" className="text-sm px-5 py-2.5">
