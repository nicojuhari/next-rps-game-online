    ...
    return (
        <article className="text-gray-600 leading-relaxed">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
                <li>
                    <strong className="text-gray-900">Zero setup:</strong> no account, no download, no waiting for the facilitator to share
                    a screen. Players open the link themselves.
                </li>
                <li>
                    <strong className="text-gray-900">No language barrier:</strong> the rules - rock beats scissors, scissors beats paper,
                    paper beats rock - take 10 seconds to explain and are already known in most cultures.
                </li>
                <li>
                    <strong className="text-gray-900">Equal footing:</strong> there&apos;s no knowledge advantage, no speaking confidence
                    required, no seniority signal. The intern and the VP play on exactly the same terms.
                </li>
                <li>
                    <strong className="text-gray-900">Instant outcome:</strong> every match produces a clear winner and a natural reaction -
                    a laugh, a groan, a rematch request. That reaction is the icebreaker doing its job.
                </li>
                <li>
                    <strong className="text-gray-900">Works on any device:</strong> phone, tablet, laptop - no browser extension, no IT
                    approval required.
                </li>
            </ul>
            ...
            <div className="space-y-3 mb-6">
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Host opens the game and creates a room</p>
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Paste the link in the meeting chat</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Both players pick their move</p>
                        <p className="text-sm text-gray-600 mt-0.5">
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        <p className="font-semibold text-gray-900">Result reveals simultaneously</p>
                        <p className="text-sm text-gray-600 mt-0.5">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 my-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Try it before your next call.</p>
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">Quick warmup for a team standup</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">Making a group decision</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">Onboarding a new team member</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">Team building tournament</h3>
            <p className="mb-4">
            ...
            <h3 className="text-base font-semibold mt-6 mb-2 text-gray-900">Breaking a tie vote</h3>
            <p className="mb-4">
                ...
                <table className="w-full text-sm border-collapse">
                    <thead>
                        <tr className="bg-gray-100 text-gray-600">
                            ...
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Time</th>
                            <th className="text-left p-3 border-b border-gray-200 font-semibold">Problem</th>
                        </tr>
                    </thead>
                    <tbody className="text-gray-600">
                        <tr>
                            <td className="p-3 border-b border-gray-200">&ldquo;Two truths and a lie&rdquo;</td>
                        ...
                        <tr>
                            <td className="p-3 border-b border-gray-200">Virtual bingo</td>
                        ...
                        <tr className="bg-gray-50">
                            <td className="p-3 border-b border-gray-200">Word association</td>
                            <td className="p-3 border-b border-gray-200">3-5 min</td>
                            <td className="p-3 border-b border-gray-200">Hard to run with more than 4-5 people; loses energy quickly</td>
                        </tr>
                        <tr>
                            <td className="p-3 border-b border-gray-200 font-semibold text-gray-900">Rock Paper Scissors</td>
            ...
            <div className="space-y-5">
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Can you play rock paper scissors on a Zoom call?</h3>
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">What are good icebreakers for virtual meetings?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">How do you run a rock paper scissors tournament on a video call?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Why is rock paper scissors a good team icebreaker?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">How long does a virtual RPS icebreaker take?</h3>
                    <p className="text-gray-600">
                ...
                <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Can rock paper scissors work with large teams?</h3>
                    <p className="text-gray-600">
            ...
            <div className="border-t border-gray-200 mt-10 pt-8 text-center">
                <p className="font-semibold text-gray-900 mb-1">Ready for your next meeting?</p>
