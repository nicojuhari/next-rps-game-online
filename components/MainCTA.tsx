            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center items-center">
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200">
                    ...
                    <button
                        ...
                        className="justify-center mt-8 w-full bg-green-500 hover:bg-green-600 disabled:bg-gray-400 disabled:cursor-not-allowed h-10 text-white py-1 px-4 rounded-md inline-flex items-center gap-2.5"
                    >
                        {loading ? (
